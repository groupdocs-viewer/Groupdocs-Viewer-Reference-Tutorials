...
### 1. क्या मैं किसी भी प्रकार के दस्तावेज़ के साथ .NET के लिए GroupDocs.Viewer का उपयोग कर सकता हूँ?
 हां, .NET के लिए GroupDocs.Viewer स्प्रेडशीट, प्रेजेंटेशन और बहुत कुछ सहित दस्तावेज़ प्रारूपों की एक विस्तृत श्रृंखला का समर्थन करता है। को देखें[प्रलेखन](https://reference.groupdocs.com/viewer/net/) पूरी सूची के लिए.
