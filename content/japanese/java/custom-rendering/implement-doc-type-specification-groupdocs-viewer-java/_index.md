---
date: '2026-02-05'
description: GroupDocs.Viewer for Java を Maven で使用し、DOCX を HTML にレンダリングする際に、ファイルタイプの設定とドキュメントタイプの指定方法を学びましょう。
keywords:
- set file type
...
- configure html view
title: GroupDocs.Viewer for Java を使用してドキュメントをレンダリングする際のファイルタイプの設定方法
type: docs
